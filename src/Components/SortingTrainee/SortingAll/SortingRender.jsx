...
const SortingRender = ({}) => {
  return(
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%' }}>
      ...
      {/* ===========================ToDay======================================================================================== */}
      <div style={{ padding: '5px' }}>
        <DayOfWeekWrapper>{today}</DayOfWeekWrapper>
        <WrapperInfoTime>
          ...
          <ol start={1} type={1} style={{ marginLeft: '10px' }}>
            {clientsToday0800 ? clientsToday0800.map((item) => (
              <Clients key={item.name}>
                <a href={URLInsta({ item })} target="_blank" rel="noopener noreferrer">
                  {item.name}</a></Clients>
      ...
      {/* ===========================NextDay======================================================================================== */}
      <div style={{ padding: '5px' }}>
        <DayOfWeekWrapper>{nextDay}</DayOfWeekWrapper>
        <WrapperInfoTime>
      ...
      {/* ===========================NextDayTwo======================================================================================== */}
      <div style={{ padding: '5px' }}>
        <DayOfWeekWrapper>{nextDay1}</DayOfWeekWrapper>
        <WrapperInfoTime>
      ...
      {/* ===========================NextDayThree=========================================== */}
      <div style={{ padding: '5px' }}>
        <DayOfWeekWrapper>{nextDay2}</DayOfWeekWrapper>
        <WrapperInfoTime>
      ...
      {/* ===========================NextDayFour======================================================================================== */}
      <div style={{ padding: '5px' }}>
        <DayOfWeekWrapper>{nextDay3}</DayOfWeekWrapper>
        <WrapperInfoTime>
      ...
      {/* ===========================NextDayFive======================================================================================== */}
      <div style={{ padding: '5px' }}>
        <DayOfWeekWrapper>{nextDay4}</DayOfWeekWrapper>
        <WrapperInfoTime>
      ...
      {/* ===========================NextDaySix======================================================================================== */}
      <div style={{ padding: '5px' }}>
        <DayOfWeekWrapper>{nextDay5}</DayOfWeekWrapper>
        <WrapperInfoTime>
